        ...
        <div className="relative h-full w-full overflow-hidden aspect-[4/5]">
          ...
          <div className="absolute bottom-4 left-4 right-4 z-10">
            <Link
              ...
              className="flex w-full items-center justify-center gap-2 rounded-2xl bg-emerald-500 py-4 text-white shadow-lg transition hover:bg-emerald-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
              <svg
                className="h-5 w-5"
                fill="none"
