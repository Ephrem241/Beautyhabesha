...
export function BlurGate({
  ...
  return (
    ...
    >
      <div
        className="select-none transition-all duration-300 blur-md will-change-[filter] [&_img]:blur-lg"
        aria-hidden="true"
      >
        {children}
      </div>
      <div
        className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/70 px-4 py-6 backdrop-blur-[2px]"
        role="presentation"
      >
